...
from te_koa.utils.clustering_manager import ClusteringManager # For type checking if needed by mocks
from te_koa.utils.dimensionality_reducer import DimensionalityReducer # For type checking if needed by mocks
...
class TestDataManagerClustering(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher_st = patch('te_koa.visualization.app_refactored_claude_components.data_manager.st', new_callable=MagicMock)
    ...
    @patch('te_koa.visualization.app_refactored_claude_components.data_manager.ClusteringManager')
    @patch('te_koa.visualization.app_refactored_claude_components.data_manager.DimensionalityReducer')
    ...
    @patch('te_koa.visualization.app_refactored_claude_components.data_manager.DimensionalityReducer') # To control the instance created by initialize_dimensionality_reducer
    ...
    @patch('te_koa.visualization.app_refactored_claude_components.data_manager.characterize_phenotypes')
